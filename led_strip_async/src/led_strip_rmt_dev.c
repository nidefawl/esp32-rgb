...
static esp_err_t led_strip_rmt_refresh_begin(led_strip_t *strip)
{
    led_strip_rmt_obj *rmt_strip = __containerof(strip, led_strip_rmt_obj, base);
    rmt_transmit_config_t tx_conf = {
        .loop_count = 0,
...
static esp_err_t led_strip_rmt_refresh_end(led_strip_t *strip)
{
    led_strip_rmt_obj *rmt_strip = __containerof(strip, led_strip_rmt_obj, base);
...
esp_err_t led_strip_new_rmt_device(const led_strip_config_t *led_config, const led_strip_rmt_config_t *rmt_config, led_strip_handle_t *ret_strip)
{
    ...
    rmt_strip->base.refreshBegin = led_strip_rmt_refresh_begin;
    rmt_strip->base.refreshEnd = led_strip_rmt_refresh_end;
