...
static esp_err_t led_strip_spi_refresh_begin(led_strip_t *strip) {
    return ESP_OK;
}

static esp_err_t led_strip_spi_refresh_end(led_strip_t *strip) {
...
esp_err_t led_strip_new_spi_device(const led_strip_config_t *led_config, const led_strip_spi_config_t *spi_config, led_strip_handle_t *ret_strip)
{
    ...
    spi_strip->base.refreshBegin = led_strip_spi_refresh_begin;
    spi_strip->base.refreshEnd = led_strip_spi_refresh_end;
